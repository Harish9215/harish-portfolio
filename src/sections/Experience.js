    ...
    <div className="max-w-5xl w-full px-6 space-y-10 mt-20">
      <h2 className="text-3xl font-bold mb-6 text-left text-[#d4af37]">Experience</h2>
        ...
        <div className="border-b border-gray-700 pb-6">
          ...
          <p className="text-gray-400 text-base mb-4">Aug 2022 – Aug 2023</p>
        ...
        <div className="pt-6">
          ...
          <p className="text-gray-400 text-base mb-4">Aug 2020 – Jul 2022</p>
          ...
          <div className="text-gray-300 text-base leading-relaxed space-y-4">
            ...
            <p>
              This role honed my skills in usercentric design, product thinking, and effective collaboration. I also utilized tools like <span className="italic">SQL</span> and <span className="italic">Tableau</span> to drive data informed design decisions and product improvements.
            </p>
          </div>
        </div>
      </div>
